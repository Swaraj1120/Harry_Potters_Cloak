...
# Capturing th initial frame for creation of background
while(True):
    cv2.waitKey(1000)
    ret, init_frame = cap.read()
    # check if the function is returned then break
    if(ret):
        break
...
while(True):
    ...
    # getting the HSV values for masking the cloal
